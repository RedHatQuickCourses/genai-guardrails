...
. Activate the virtual environment you created in the previous labs. If you have not created a virtual environment, create a new one and activate it.
+
[source,subs="verbatim,quotes"]
--
...
. Inspect the `guardian-hap.py` file in the editor of your choice. We download and instantiate the 125m HAP model from the Hugging Face repository:
+
[source,subs="verbatim,quotes"]
--
...
